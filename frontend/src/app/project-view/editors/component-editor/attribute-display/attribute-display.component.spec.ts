...
describe('AttributeDisplayComponent', () => {
  ...
  it('should emit destroy', () => {
    const onClickMock = spyOn(comp.destroyAttribute, 'emit');
  ...
  it('should emit change name', async(() => {
    const onClickMock = spyOn(comp.nameChangeAttribute, 'emit');
  ...
  it('should emit description change', async(() => {
    const onClickMock = spyOn(comp.descriptionChangeAttribute, 'emit');
    const event = new KeyboardEvent('keyup');
