import {
    Component, ElementRef, EventEmitter, Input, OnChanges, Output, QueryList, SimpleChanges, ViewChildren, ViewEncapsulation
} from '@angular/core';
...
export class FlowEditorComponent implements OnChanges {
    ...
    constructor(private designerService: DesignerService, private flowNodeService: FlowNodeService,
    ...
    saveFlow() {
        ...
        for (let cell of this.graph.toJSON().cells) {
            ...
            let defaultCell = this.flowNodeService.defaults[cell.type];
            for (let i in cell) {
