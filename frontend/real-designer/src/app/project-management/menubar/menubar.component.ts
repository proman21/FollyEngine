...
export class MenubarComponent implements OnInit {
    ...
    /* Sidebar Control */
    @Output() onPressSideBar = new EventEmitter<string>();
    pressedSideBar() {
        this.onPressSideBar.emit();
    }

    /* File Menu Control */
    @Output() onOpenWelcome = new EventEmitter<string>();
    selectedOpenWelcome () {
    ...
    @Output() onPressSave = new EventEmitter<string>();
    pressedSave() {
    ...
    /* Entity Menu Control */
    @Output() onPressNewEntity = new EventEmitter<string>();
    pressedNewEntity() {
    ...
    @Output() onPressNewComponent = new EventEmitter<string>();
    pressedNewComponent() {
        // Action to add new entity to entity screen
    ...
    /* User Menu Control */
    @Output() onOpenSettings = new EventEmitter<string>();
